...
| `NEXT_PUBLIC_SEARCH_RESULTS_NOTIFICATION` | string  | "Due to winter holiday closures, the delivery time for off-site requests will be delayed..." | A string that can including html that will be rendered as a notification on the Home and Search Results pages.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
