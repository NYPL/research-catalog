const QABanner = () => {
  return (
    <div
      id="qa-banner"
      style={{
        background: "var(--ui-status-primary, #F9E08E)",
        color: "black",
        fontSize: "14px",
        display: "flex",
    ...
    >
      ...
      <div style={{ textAlign: "center" }}>
        ...
        testing purposes only. Items cannot be requested from this test site.
        <br />
        <a
          style={{
          ...
          href="https://www.nypl.org/research/research-catalog"
        >
          Go to the live site instead
        </a>
      </div>
    </div>
  )
